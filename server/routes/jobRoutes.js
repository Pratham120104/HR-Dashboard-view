...
router.patch("/:id/status", validateObjectId(), writeLimiter, asyncHandler(setJobStatus));

// Read / Update / Delete
router.get("/:id", validateObjectId(), asyncHandler(getJobById));
router.put("/:id", validateObjectId(), writeLimiter, asyncHandler(updateJob));
router.patch("/:id", validateObjectId(), writeLimiter, asyncHandler(updateJob));
router.delete("/:id", validateObjectId(), writeLimiter, asyncHandler(deleteJob));
